...
public class MathExpImpl extends MinimalEObjectImpl.Container implements MathExp
{
   ...
   * @ordered
   */
  protected EList<ExternalMethod> externals;
   ...
   */
  @Override
  public EList<ExternalMethod> getExternals()
  {
    if (externals == null)
    {
      externals = new EObjectContainmentEList<ExternalMethod>(ExternalMethod.class, this, MathPackage.MATH_EXP__EXTERNALS);
    }
    return externals;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MathPackage.MATH_EXP__EXTERNALS:
        getExternals().clear();
        getExternals().addAll((Collection<? extends ExternalMethod>)newValue);
        return;
      case MathPackage.MATH_EXP__VARIABLES:
        getVariables().clear();
